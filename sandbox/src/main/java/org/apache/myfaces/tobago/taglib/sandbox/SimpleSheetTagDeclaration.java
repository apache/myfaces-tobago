...
import org.apache.myfaces.tobago.taglib.component.SheetTagDeclaration;
...
@UIComponentTag(
    ...
    rendererType = "SimpleSheet")
public interface SimpleSheetTagDeclaration extends TobagoTagDeclaration, HasIdBindingAndRendered {
  /**
