...
*/
  ...
  initializingDone: function () {
    jQuery(".tobago-page-initializing").removeClass("tobago-page-initializing");
  },
...
Tobago.registerListener(Tobago.initializingDone, Tobago.Phase.DOCUMENT_READY);
