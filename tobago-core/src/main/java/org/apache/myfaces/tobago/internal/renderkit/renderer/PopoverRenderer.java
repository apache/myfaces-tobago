...
public class PopoverRenderer<T extends AbstractUIPopover> extends RendererBase<T> {
  ...
  public void encodeBeginInternal(final FacesContext facesContext, final T component) throws IOException {
    ...
    if (component.getCustomClass() != null) {
      writer.writeAttribute(DataAttributes.BS_CUSTOM_CLASS, component.getCustomClass().getName(), true);
    }
    ...
    if (SanitizeMode.auto == component.getSanitize()) {
      ...
      if (labelString != null && !labelString.isEmpty()) {
        writer.writeAttribute(DataAttributes.BS_TITLE, sanitizer.sanitize(labelString), true);
      }
      writer.writeAttribute(DataAttributes.BS_CONTENT, sanitizer.sanitize(currentValue), true);
    } else {
      if (labelString != null && !labelString.isEmpty()) {
        writer.writeAttribute(DataAttributes.BS_TITLE, labelString, true);
      }
      writer.writeAttribute(DataAttributes.BS_CONTENT, currentValue, true);
    }
