...
public interface SheetTagDeclaration
  ...
  /**
   * Flag indicating that the sheet is readonly.
   ...
   * When set to true, it signals the sheet is read-only und
   * doesn't require updates. This effectively skips
   * <code>UISheet.processDecode(FacesContext)</code> and
   * <code>UISheet.processValidators(FacesContext)</code> and
   * <code>UISheet.processUpdates(FacesContext)</code>,
   ...
   * and in any facet of sheet or columns and columns are not sortable.
   *
   */
  @TagAttribute
  @UIComponentTagAttribute(type = "boolean", defaultValue = "false")
