...
public interface TimeTagDeclaration
    extends HasIdBindingAndRendered, HasValidator, HasValue, HasValueChangeListener, HasTabIndex, IsFocus, IsVisual,
    HasValidatorMessage, HasConverterMessage, HasRequiredMessage, IsReadonly,
    IsDisabled, HasConverter, HasLabel, HasLabelLayout, HasTip, IsRequired, HasPlaceholder {
