...
public class Command {
  ...
  public Command(
      ...
      final Collapse collapse, final Boolean omit, final Boolean stopPropagation, final String jsEventName) {
