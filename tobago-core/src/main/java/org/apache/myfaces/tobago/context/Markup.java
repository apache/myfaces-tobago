...
public final class Markup implements Serializable, Iterable<String> {
  ...
  public static final Markup OUTLINE_DANGER = valueOf("outline-danger");
  public static final Markup OUTLINE_DARK = valueOf("outline-dark");
  public static final Markup OUTLINE_INFO = valueOf("outline-info");
  public static final Markup OUTLINE_LIGHT = valueOf("outline-light");
  public static final Markup OUTLINE_PRIMARY = valueOf("outline-primary");
  public static final Markup OUTLINE_SECONDARY = valueOf("outline-secondary");
  public static final Markup OUTLINE_SUCCESS = valueOf("outline-success");
  public static final Markup OUTLINE_WARNING = valueOf("outline-warning");
