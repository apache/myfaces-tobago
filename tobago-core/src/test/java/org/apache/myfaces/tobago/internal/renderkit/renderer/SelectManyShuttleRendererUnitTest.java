...
public class SelectManyShuttleRendererUnitTest extends RendererTestBase {
  ...
  public void simple() throws IOException {
    ...
    addSelectItem("i1", "Value 1", null, c);
    addSelectItem("i2", "Value 2", null, c);
  ...
  public void selected() throws IOException {
    final UISelectManyShuttle c = (UISelectManyShuttle) ComponentUtils.createComponent(
        facesContext, Tags.selectManyShuttle.componentType(), RendererTypes.SelectManyShuttle, "id");
    c.setValue(new String[]{"v2", "v4"});

    addSelectItem("i1", "Value 1", "v1", c);
    addSelectItem("i2", "Value 2", "v2", c);
    addSelectItem("i3", "Value 3", "v3", c);
    addSelectItem("i4", "Value 4", "v4", c);
  ...
  private void addSelectItem(String id, String itemLabel, String itemValue, UISelectManyShuttle shuttle) {
    ...
    shuttle.getChildren().add(selectItem);
  }
}
