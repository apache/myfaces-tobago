...
public class UserAgentUnitTest {
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void test(final String title, final UserAgent agent, final String headerString) {
    Assertions.assertEquals(agent, UserAgent.getInstance(headerString));
  }

  public static Stream<Arguments> data() {
    return Stream.of(
        Arguments.of("Internet Explorer 6 - Windows 2000",
            UserAgent.MSIE_6_0,
            "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0"),

        Arguments.of("Internet Explorer 6 - Windows XP",
            UserAgent.MSIE_6_0,
            "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)'"),

        Arguments.of("Internet Explorer 7 - Windows XP",
            UserAgent.MSIE_7_0,
            "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1)"),

        Arguments.of("Internet Explorer 8 - Windows XP",
            UserAgent.MSIE_8_0,
            "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0; .NET CLR 2.0.50727;"
                + " .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729)"),

        Arguments.of("Internet Explorer 8 - Compatibility Mode - Windows XP",
            UserAgent.MSIE_7_0_COMPAT,
            "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0)"),

        Arguments.of("Internet Explorer 9 preview - Windows 7",
            UserAgent.MSIE_9_0,
            "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0)"),

        Arguments.of("Internet Explorer 9 - Windows 7",
            UserAgent.MSIE_9_0,
            "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Win64; x64; Trident/5.0)"),

        Arguments.of("Internet Explorer 9 - Compatibility Mode - Windows 7",
            UserAgent.MSIE_7_0_COMPAT,
        ...
        Arguments.of("Web-Browser for S60 - Symbian - Nokia E51",
            UserAgent.WEBKIT,
            "Mozilla/5.0 "
