 ...
 */
package org.apache.myfaces.tobago.apt.ant;
...
import org.apache.myfaces.tobago.apt.ant.compiler.AptCompilerAdapter;
import org.apache.myfaces.tobago.apt.ant.compiler.AptExternalCompilerAdapter;

/**
 * XXX Remove if Ant 1.7 is released.
 *
...
public class Apt extends Javac {
  ...
  // overwritten to avoid classloader issues: if tobago-apt is
  // not located in ant lib dir ant fails to resolveClassName
  protected void compile() {
    ...
    if (compileList.length > 0) {
      ...
      CompilerAdapter adapter = new AptExternalCompilerAdapter();
