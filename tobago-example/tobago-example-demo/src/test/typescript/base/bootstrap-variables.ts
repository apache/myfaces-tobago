...
export class Table {
  ...
  static readonly stripedBg = "rgba(var(--bs-emphasis-color-rgb), 0.05)";
  static readonly activeColor = "var(--bs-emphasis-color)";
  static readonly activeBg = "rgba(var(--bs-emphasis-color-rgb), 0.1)";
  static readonly hoverColor = "var(--bs-emphasis-color)";
  static readonly hoverBg = "rgba(var(--bs-emphasis-color-rgb), 0.075)";
}
