...
test.describe("900-test/selectManyList/no-entries/No_entries.xhtml", () => {
  test.beforeEach(async ({page}) => {
    await page.goto("/content/900-test/selectManyList/no-entries/No_entries.xhtml");
  });

  test("SelectManyList: no-entries hint after leaving", async ({page}) => {
    const rootComponent = page.locator("[id='page:mainForm:selectManyList']");
