...
test.describe("900-test/selectOneList/leave-component/Leave_component.xhtml", () => {
  test.beforeEach(async ({page}) => {
    await page.goto("/content/900-test/selectOneList/leave-component/Leave_component.xhtml");
  });
