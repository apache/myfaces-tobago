...
test.describe("900-test/selectOneList/custom-footer/Custom_footer.xhtml", () => {

  test.beforeEach(async ({page}) => {
    await page.goto("/content/900-test/selectOneList/custom-footer/Custom_footer.xhtml");
  });
