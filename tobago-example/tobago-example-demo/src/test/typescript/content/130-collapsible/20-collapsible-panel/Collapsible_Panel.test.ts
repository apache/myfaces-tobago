...
test.describe("130-collapsible/20-collapsible-panel/Collapsible_Panel.xhtml", () => {

  test.beforeEach(async ({page}) => {
    await page.goto("/content/130-collapsible/20-collapsible-panel/Collapsible_Panel.xhtml");
  });

  test("Simple Panel: submit empty input, hide, submit, show, submit valid input", async ({page}) => {
    ...
    const panelCollapsed = page.locator("[id='page:mainForm:simple:simplePanel::collapse']");
    ...
    await expect(panelCollapsed).toHaveValue("false");
    ...
    await hide.click();
    await expect(panelCollapsed).toHaveValue("true");
  ...
  test("Full Server Request: submit empty input, hide, submit, show, submit valid input", async ({page}) => {
    ...
    const panelCollapsed = page.locator("[id='page:mainForm:server:serverPanel::collapse']");
  ...
  test("Client Sided: submit empty input, hide, submit, show, submit valid input", async ({page}) => {
    ...
    const panelCollapsed = page.locator("[id='page:mainForm:client:clientPanel::collapse']");
  ...
  test("Ajax: submit empty input, hide, submit, show, submit valid input", async ({page}) => {
    ...
    const panelCollapsed = page.locator("[id='page:mainForm:ajax:ajaxPanel::collapse']");
