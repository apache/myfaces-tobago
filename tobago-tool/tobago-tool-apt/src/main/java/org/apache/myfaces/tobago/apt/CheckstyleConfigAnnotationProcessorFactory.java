...
public class CheckstyleConfigAnnotationProcessorFactory implements AnnotationProcessorFactory  {
  ...
  private CheckstyleConfigAnnotationProcessor annotationProcessor = null;
  ...
  public AnnotationProcessor getProcessorFor(Set<AnnotationTypeDeclaration> declarations,
    ...
    if (annotationProcessor == null) {
      annotationProcessor = new CheckstyleConfigAnnotationProcessor(declarations, env);
    }
